...
void UiColorConfig::Init()
{
  ...
  {
    { "top_attr", "" },
    { "top_color_bg", "0x007063" },
    { "top_color_fg", "0xffefef" },
    { "help_attr", "reverse" },
    { "help_color_bg", "black" },
    { "help_color_fg", "white" },
    { "entry_attr", "" },
    ...
    { "entry_color_fg", "" },
    { "status_attr", "reverse" },
    { "status_color_bg", "0x007063" },
    { "status_color_fg", "0xffefef" },
    { "vim_navigation_status_color_list_bg", "0xe0e0e0" },
    { "vim_navigation_status_color_list_fg", "" },
    { "vim_navigation_status_color_history_bg", "" },
    { "vim_navigation_status_color_history_fg", "" },
    { "list_attr", "" },
    { "list_attr_selected", "bold" },
    { "list_color_bg", "" },
    { "list_color_fg", "" },
    { "list_color_unread_fg", "0x4A9900" },
    { "list_color_unread_bg", "" },
    { "listborder_attr", "" },
    { "listborder_color_bg", "" },
    { "listborder_color_fg", "" },
    { "history_text_attr", "" },
    { "history_text_attr_selected", "bold" },
    ...
    { "history_text_recv_group_color_fg", "0x2B009E" },
    { "history_name_attr", "" },
    { "history_name_attr_selected", "bold" },
    { "history_name_sent_color_bg", "" },
    { "history_name_sent_color_fg", defaultSentColor },
    { "history_name_recv_color_bg", "" },
    { "history_name_recv_color_fg", "0x936BFF" },
    { "history_name_recv_group_color_bg", "" },
    { "history_name_recv_group_color_fg", "0x936BFF" },
    { "dialog_attr", "" },
    { "dialog_attr_selected", "reverse" },
    { "dialog_color_bg", "" },
    { "dialog_color_fg", "0x007063" },
